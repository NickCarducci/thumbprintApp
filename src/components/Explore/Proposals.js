...
import HolderSwitchCommunities from "./HolderSwitchCommunities";
import "./Proposals.css";
import Proposal from "../proposalpagesredux/proposal";
...
class Proposals extends React.Component {
  ...
  loadMoreBills = async () => {
    ...
    await fetch(
      `https://cors-anywhere.herokuapp.com/https://api.govinfo.gov/collections/BILLS/2017-01-01T00%3A00%3A00Z/2020-01-01T00%3A00%3A00Z?offset=${thisone}&pageSize=10&congress=116&api_key=h117c5VnhjOhrVOi5xxP2uF21ffX6gkQTUF1AL8E`
    )
