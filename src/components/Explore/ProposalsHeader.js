  ...
  render(props) {
    return (
      ...
      {this.props.switchCommunitiesOpen === false?
          <div className="clicklandercity" onClick={this.props.switchCommunitiesOpener}>
        ...
        <form onSubmit={this.stopSubmit}>
          <input className="Events_Header" type="text"
        name="note" placeholder="Proposals" 
        ...
        <img
          ...
          className={this.props.eventTypesOpen ? "square_dot_types" : "square_dot"}
          onClick={
            window.location.pathname === "/proposals" ? this.props.toggle : null
          }
          alt="error"
        /></div>
        <img src="https://www.dl.dropboxusercontent.com/s/szxg897vw4bwhs3/filter%20%281%29.png?dl=0" className="filter" onClick={
            window.location.pathname === "/proposals" ? this.props.eventTypesOpener : null
          } alt="error" />
      </div>
    );
  }
