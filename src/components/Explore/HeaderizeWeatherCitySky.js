...
const API_KEY = "093e77411870dcc926cc32d516f15526";
...
class HeaderizeWeatherCitySkyMap extends React.Component {
  ...
  componentDidMount() {
    this.it = setInterval(() => this.currentTime(), 3600000)
  }
      ...
      <div>
        <div>
          ...
          {this.state.city === "New York" ? (
            <img src="https://www.dl.dropboxusercontent.com/s/w6d0vb32ggf0udx/City%28Feather%29%20%283%29.gif?dl=0" className="city_header" alt="error" />
          ) : (
