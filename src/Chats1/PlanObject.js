  ...
  addNoteFromEvent = (note) => {
    ...
    addDoc(collection(firestore, "chats"), {
      ...
      .then((docRef) => {
        ...
        var goo = {};
        goo.title = note.message;
        goo.body = note.ticketLink;
        goo.entityId = this.props.entityId;
        goo.entityType = this.props.entityType;
        ...
        goo._id = docRef.id;
        this.props.handleSave(goo, "createNote");
        ...
        if (false && this.props.auth !== undefined)
            ...
            <div
              ...
              onClick={async () => {
                ...
                if (noteList.includes(id)) {
                  ...
                  if (deleteAll) {
                    if (note) {
                      deleteDoc(doc(firestore, "chats", id))
                        .then((ref) => {
                          console.log("deleted plan from messages " + id);
                        })
                        .catch(standardCatch);
                      deleteDoc(doc(firestore, "calendar", id))
                        .then((ref) => {
                          console.log("deleted plan from calendar " + id);
                        })
                        .catch(standardCatch);
                      await this.state.db
                        .deleteNote({ _id: id })
                        .then(() => {
                          console.log("deleted plan from local " + id);
                          this.getNotes();
                        })
                        .catch(standardCatch);
                    } else {
